          ...
          <RevealItem as="li" key={person.name} className="group">
            <div className="relative aspect-4/5 overflow-hidden bg-paper-2">
              <Image
                ...
                className="object-cover grayscale transition-all duration-[1.1s] ease-out-expo group-hover:scale-[1.025] group-hover:grayscale-0"
              />
            ...
            <div className="border-b border-line py-6">
              <h3 className="display-sm">{person.name}</h3>
